    ...
    en: {
      ...
      tx: {
        ...
        split: {
          ...
          openBtn:          'Split',
          cancelBtn:        'Cancel',
          removeBtn:        'Remove splits',
          addRow:           '+ Add row',
          fillRemaining:    'Fill remaining',
          total:            'Total: {amount} {currency}',
          balanced:         'Balanced',
          remaining:        'Remaining',
          minRows:          'At least 2 rows required',
          saveDisabledHint: 'Splits must balance to the parent total',
          confirmRemove:    'Remove all splits and restore the original transaction?',
          removed:          'Splits removed.',
          saved:            'Transaction split saved.',
          collapseAll:      'Collapse all splits',
      ...
      reports: {
        ...
        loadFailed:     'Failed to load report: {error}',
        showNative:     'Show native currencies',
        showConverted:  'Show {currency} equivalent',
        metrics: {
          totalIncome:   'Total income',
      ...
      accounts: {
        ...
        modal: {
          ...
          depthHint:   'Max hierarchy depth: {max}',
          notes:       'Notes',
          createBtn:   'Create account',
          deleteDesc:  'Delete "{name}" and reassign all its linked items.',
        ...
        toast: {
          ...
          depthExceeded:      'Max hierarchy depth ({max}) would be exceeded.',
          setDefaultConfirm:  'Set "{name}" as the default account for this workspace?',
          defaultSet:         'Default account updated.',
          reassignReq:        'Please select a reassignment account.',
      ...
      splitRules: {
        title:       'Split rules',
        addBtn:      '+ Add split rule',
        description: 'When importing, if a transaction matches a rule\'s conditions, it is automatically split into the defined child transactions. Rules are evaluated after categorisation rules — first match wins.',
        noRules:     'No split rules yet',
        noRulesSub:  'Add a split rule to auto-split imported transactions.',
        modal: {
          titleAdd:           'Add split rule',
          titleEdit:          'Edit split rule',
          name:               'Rule name *',
          namePlaceholder:    'e.g. Rent + utilities',
          enabled:            'Enabled',
          conditionsTitle:    'Conditions (ALL must match)',
          addCondition:       '+ Add condition',
          templateTitle:      'Split template',
          modeFixed:          'Fixed amounts',
          modePercent:        'Percent',
          amountHeaderFixed:  'Amount',
          amountHeaderPct:    'Percent',
          templateSummaryFixed: 'Total: {sum}',
          templateSummaryPct:   '{sum}% of 100%',
          saveBtn:            'Save rule',
          condField:          'Field',
          condOp:             'Operator',
          condVal:            'Value',
        ...
        toast: {
          saved:         'Split rule saved.',
          deleted:       'Split rule deleted.',
          saveFailed:    'Save failed: {error}',
          nameReq:       'Rule name is required.',
          condReq:       'At least one condition is required.',
          templateReq:   'At least 2 template rows are required.',
          pctSum:        'Percent values must sum to 100.',
          mixedMode:     'All template rows must use the same amount type.',
        },
      },
      settings: {
